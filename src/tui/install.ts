...
export const DEPENDENCY_CLOSURE_RELATIVE = ['src/tui/footer.ts', 'src/tui/openrouter-subprocess.ts', 'src/data/git.ts', 'src/data/openrouter-weekly.ts', 'src/data/project-status.ts', 'src/types/index.ts', 'src/utils/config.ts'];
