...
export function buildRenderContext(state: OpencodeState, getLimit: LimitLookup, opts: { now?: number; termWidth?: unknown; git?: GitInfo; openrouterWeekly?: OpenRouterWeeklyContext } = {}): RenderContext {
  ...
  return { state, derived, git, termWidth, now, openrouterWeekly: opts.openrouterWeekly ?? emptyOpenRouterWeekly };
}
