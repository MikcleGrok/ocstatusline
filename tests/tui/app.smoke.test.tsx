...
describe('App smoke', () => {
  ...
  it('color edit lands on the selected widget, not item 0', async () => {
    ...
    stdin.write(DOWN); await delay(10);   // item 4 (production-version)
    stdin.write(DOWN); await delay(10);   // item 5 (separator)
    stdin.write(DOWN); await delay(10);   // item 6 (git-branch)
